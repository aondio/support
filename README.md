...
GeoDNS /traffic router - Determines which is the best route from one location to another, routing traffic based on specific geographical location to a given requesting IP address.
